...
export const tailwindDark: ChronoScopeClassNames = {
  ...
  calendarDay: "aspect-square flex items-center justify-center rounded-md text-xs cursor-pointer hover:bg-teal-500/15 transition-colors border-none bg-transparent  font-mono",
...
export const tailwindLight: ChronoScopeClassNames = {
  ...
  calendarGrid: "grid grid-cols-7 gap-0.5",
  calendarDayEmpty: "aspect-square",
  calendarDay: "aspect-square flex items-center justify-center rounded-md text-xs cursor-pointer hover:bg-teal-100/50 transition-colors border-none",
  calendarDayToday: "ring-1 ring-teal-600 text-teal-700 font-bold",
  calendarDaySelected: "bg-teal-600 font-bold hover:bg-teal-500",
  calendarDayInRange: "bg-teal-100/40",
  calendarDayDisabled: "opacity-30 cursor-not-allowed hover:bg-transparent",
  timeRow: "flex gap-4 mb-4",
  timeInput: "flex-1 flex items-center gap-2",
